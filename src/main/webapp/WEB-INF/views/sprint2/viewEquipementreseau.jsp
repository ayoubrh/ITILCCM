...
<head>
	...
	<title>Détail Equipement reseau - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail Equipement reseau</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/equipementreseau?id=${equipementReseau.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/equipementreseau?id=${equipementReseau.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										...
										${equipementReseau.nom }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Statut : </label>
										${equipementReseau.statut }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Criticité : </label>
										${equipementReseau.criticite }
									</div>
									
									
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Lieu : </label>
										<a href="<c:url value="/config/view/lieu?id=${equipementReseau.lieu.id }" />">${equipementReseau.lieu.nom }</a>										
										
									</div>
									
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Rack : </label>
										<a href="<c:url value="/config/view/rack?id=${equipementReseau.rack.id }" />">${equipementReseau.rack.nom }</a>
										
									</div>
									
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Chassis : </label>
										<a href="<c:url value="/config/view/chassis?id=${equipementReseau.chassis.id }" />">${equipementReseau.chassis.nom }</a>
										
									</div>
									
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Type : </label>
										${equipementReseau.type }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Marque : </label>
										${equipementReseau.marque }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Modèle : </label>
										${equipementReseau.modele }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Version IOS : </label>
										${equipementReseau.versionIos }
									</div>
									...
									<div class="form-group">
										...
										${equipementReseau.connexionElectrique[0].nom }
									...
									<div class="form-group">
										...
										${equipementReseau.connexionElectrique[1].nom }
                         			...
                         			<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tableSolutionApplicative">
												...
												<c:forEach items="${equipementReseau.solutionApplicative}" var="sa">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tableinterfacereseau">
												<c:forEach items="${equipementReseau.intefaceReseau}" var="ir">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tablecontact">
												<c:forEach items="${equipementReseau.contact}" var="contact">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tabledocument">
												<c:forEach items="${equipementReseau.document}" var="doc">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tablecontrat">
												<c:forEach items="${equipementReseau.contrat}" var="contrat">
								...
								<div class="tab-pane fade widget-tickets" id="profile-tabs-tickets">
										...
										<div class="table-primary">
											<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example-tickets">
												...
												<tbody>
												<c:forEach items="${equipementReseau.ticketsIncident}" var="ticket">
