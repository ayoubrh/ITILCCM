									...
									<div class="row">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/tapelibrary.png" alt="" class="">&nbsp; Bandoth鑡ue : 0
													</a>
												</div>
												<div class="col-md-12">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/switch.png" alt="" class="">&nbsp; Equipement r閟eau : 0
													</a>
												</div>
												<div class="col-md-12">
										...
										<div class="col-sm-4 col-md-12">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/storageArea.png" alt="" class="">&nbsp; Syst鑝e de stockage : 0
													</a>
												</div>
												<div class="col-md-12">
								...
								<div>
									...
									<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Ordinateur</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/ipphone.png" alt="" class="">&nbsp; T閘閜hone fixe : 0
													</a>
												</div>
												<div class="col-md-12">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/mobile-phone.png" alt="" class="">&nbsp; T閘閜hone mobile : 0
													</a>
												</div>
												<div class="col-md-12">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/peripherals.png" alt="" class="">&nbsp; P閞iph閞ique : 0
													</a>
												</div>
												<div class="col-md-12">
									...
									<div class="col-sm-4 col-md-4">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/database.png" alt="" class="">&nbsp; Serveur de base de donn閑s : 0
													</a>
												</div>
												<div class="col-md-12">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/database-schema.png" alt="" class="">&nbsp; Instance de base de donn閑s : 0
													</a>
												</div>
												<div class="col-md-12">
								...
								<div>
									...
									<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/interface.png" alt="" class="">&nbsp; Interface R閟eau : 0
													</a>
												</div>
												<div class="col-md-12">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/business-process.png" alt="" class="">&nbsp; Processus m閠ier : 0
													</a>
												</div>
												<div class="col-md-12">
