		...
		<div class="panel">
					...
					<div class="panel-body">
						<div id="ui-accordion">
									...
									<div class="row">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/rack" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Rack</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/chassis" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Chassis</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/serveur" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Serveur</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Switch SAN</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type NAS</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/tapelibrary.png" alt="" class="">&nbsp; Bandoth鑡ue : ${Bandotheque }
													</a>
												</div>
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Bandoth鑡ue</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type Bandoth鑡ue</span></a>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/typeConnexionElectrique" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Connection Electrique</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type DVR</span></a><br>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/switch.png" alt="" class="">&nbsp; Equipement r閟eau : ${Equipementreseau }
													</a>
												</div>
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Equipement r閟eau</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type Equipement r閟eau</span></a>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4 col-md-12">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/storageArea.png" alt="" class="">&nbsp; Syst鑝e de stockage : ${Systemedestockage }
													</a>
												</div>
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Syst鑝e de stockage</span></a><br>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type Syst鑝e de stockage</span></a>
												</div>
											</div>
										</div>
								...
								<div>
									...
									<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/vCluster" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type vCluster</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/hyperviseur" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Hyperviseur</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/machineVirtuelle" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Machine virtuelle</span></a>
							...
							<div class="group">
								<h3><img src="<%=request.getContextPath()%>/resources/assets/images/png/team.png" alt="" class="">&nbsp; <strong>P閞iph閞iques utilisateurs</strong> </h3>
								<div>
									...
									<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/pc"/>"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Ordinateur</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/ipphone.png" alt="" class="">&nbsp; T閘閜hone fixe : ${Telephonefixe }
													</a>
												</div>
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/telefixe"/>"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type T閘閜hone fixe</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type T閘閜hone fixe</span></a>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/mobile-phone.png" alt="" class="">&nbsp; T閘閜hone mobile : ${Telephonemobile }
													</a>
												</div>
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/telemobile"/>"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type T閘閜hone mobile</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type T閘閜hone mobile</span></a>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/sim"/>"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Carte SIM</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/tablette"/>"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Tablette</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/imp"/>"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Imprimante</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/peripherals.png" alt="" class="">&nbsp; P閞iph閞ique : ${Peripherique }
													</a>
												</div>
												<div class="col-md-12">
													<a href="<c:url value="/config/admin/add/per"/>"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type P閞iph閞ique</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type P閞iph閞ique</span></a>
												</div>
											</div>
										</div>
								...
								<div>
									...
									<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/middleware" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Middleware</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/serveurWeb" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Serveur Web</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/database.png" alt="" class="">&nbsp; Serveur de base de donn閑s : ${Serveurdebasededonnees }
													</a>
												</div>
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/serveurBD" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Serveur de base de donn閑s</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type Serveur de base de donn閑s</span></a>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/logicielPc" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Logiciel PC</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/autreLogiciel" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Autre logiciel</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/instanceMiddleware" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Instance Middleware</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/database-schema.png" alt="" class="">&nbsp; Instance de base de donn閑s : ${Instancedebasededonnees }
													</a>
												</div>
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/instanceBD" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Instance de base de donn閑s</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type Instance de base de donn閑s</span></a>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/applicationWeb" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Application Web</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/typeLicense" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type License</span></a>
								...
								<div>
									...
									<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/interface.png" alt="" class="">&nbsp; Interface R閟eau : ${InterfaceReseau }
													</a>
												</div>
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Interface R閟eau</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type Interface R閟eau</span></a>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Subnet</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type VLAN</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Volume logique</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												<div class="col-md-12">
													<a href="#" style="color:black;">
														<img src="<%=request.getContextPath()%>/resources/assets/images/png/business-process.png" alt="" class="">&nbsp; Processus m閠ier : ${Processusmetier }
													</a>
												</div>
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/processusMetier" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Processus m閠ier</span></a>
													<a href="#"><span class="fa fa-angle-double-right"> Rechercher des objets de type Processus m閠ier</span></a>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/solutionApplicative" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Solution applicative</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/groupe" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Groupe</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a href="#"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Camera</span></a>
