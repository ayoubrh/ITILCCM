...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Nouveau Processus Métier - ITIL-CCM</title>
 ...
 <!-- Modal Contact -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Nouveau Processus Métier</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="processusMetier" action="saveProcessusMetier" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
