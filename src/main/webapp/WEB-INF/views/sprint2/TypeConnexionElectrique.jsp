...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title"><img src="<%=request.getContextPath()%>/resources/assets/images/png/power-connection.png" alt="" class="">&nbsp; <strong>Type Connection Electrique</strong></span>
					</div>
