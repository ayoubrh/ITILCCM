...
<head>
	...
	<title>Nouveau Hyperviseur - ITIL-CCM</title>
 ...
 <!-- Modal Contact -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Nouveau Hyperviseure</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="hyperviseur" action="saveHyperviseur" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
