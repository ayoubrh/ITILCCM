...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Logiciel PC - ITIL-CCM</title>
	...
	<!-- Modal Solutions Applicatives -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification de Logiciel PC</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="logicielPc" action="/config/admin/add/saveLogicielPc" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
						...
						<div class="form-group required">
								...
								<div class="col-sm-9">
									...
									<c:if test="${logicielPc.serveur.id != null }">
										<option value="serv_${logicielPc.serveur.id }">${logicielPc.serveur.nom }</option>
									</c:if>
									<c:if test="${logicielPc.machineVirtuelle.id != null }">
										<option value="mach_${logicielPc.machineVirtuelle.id }">${logicielPc.machineVirtuelle.nom }</option>
									</c:if>
									<option value=""></option>
				...
				<div class="form-group ">
					<label for="jq-validation-email" class="col-sm-3 control-label">Date de mise en production</label>
						...
						<div class=" col-sm-9" >
								  ...
								  <div class="table-primary">
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tableContact">
											<c:forEach items="${logicielPc.contacts}" var="contact">
												<tr class="gradeA" id="tr_contact_${contact.id }">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tabledocument">
													<c:forEach items="${logicielPc.documents}" var="doc">
													<tr class="gradeA" id="tr_doc_${doc.id }">
								...
								<div class="tab-pane fade widget-solutions" id="profile-tabs-solutions">
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tableSolutionApplicative">
												<c:forEach items="${logicielPc.solutionApplicative}" var="sa">
												<tr class="gradeA" id="tr_SolutionApplicative_${sa.id }">
								...
								<div class="tab-pane fade widget-contrats" id="profile-tabs-contrats">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tableContrat">
												<c:forEach items="${logicielPc.contrats}" var="contrat">
												<tr class="gradeA" id="tr_contrat_${contrat.id }">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/logicielPc?id=${logicielPc.id }" />'">Annuler</button>
								</div>
