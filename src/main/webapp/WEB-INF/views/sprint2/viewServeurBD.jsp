...
<head>
	...
	<title>Détail Serveur de base de données- ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail du Serveur de base de données</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/serveurBD?id=${serveurBD.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/serveurBD?id=${serveurBD.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										...
										<a href="<c:url value="/config/view/serveur?id=${serveurBD.serveur.id }" />">${serveurBD.serveur.nom }</a>
										</c:if>
										<c:if test="${serveurBD.machineVirtuelle.id != null }">
										<a href="<c:url value="/config/view/machineVirtuelle?id=${serveurBD.machineVirtuelle.id }" />">${serveurBD.machineVirtuelle.nom }</a>
										</c:if>
									...
									<div class="form-group">
										...
										<a href="<c:url value="/config/view/licenceLogiciel?id=${serveurBD.licenseLogiciel.id }" />">${serveurBD.licenseLogiciel.nom }</a>
									</div>
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Chemin d'installation: </label>
										${serveurBD.cheminD_installation }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Date de mise en production: </label>
										<fmt:formatDate type="date" dateStyle="long" value="${serveurBD.dateDeMiseEnProduction }" />
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label">Description: </label>
										${serveurBD.description }
									</div>
