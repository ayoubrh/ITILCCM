...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Nouveau Version OS - ITIL-CCM</title>
...
-->
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Nouveau Version OS</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="versionOs" action="saveVersionOs" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
