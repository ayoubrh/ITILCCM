...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Nouveau Logiciel PC - ITIL-CCM</title>
	...
	<!-- Modal Solutions Applicatives -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Nouveau Logiciel PC</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="logicielPc" action="saveLogicielPc" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
