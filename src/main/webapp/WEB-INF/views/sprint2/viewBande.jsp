...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Détail Bande - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail µBande</span>
						<a href="<c:url value="/config/admin/edit/bande?id=${bande.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/bande?id=${bande.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
