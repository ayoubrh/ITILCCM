  ...
  <!-- Modal Contact -->
		...
		<div class="panel">
					...
					<div class="panel-body">
						<f:form modelAttribute="instanceDeBasseDeDonnes" action="saveInstanceBD" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
