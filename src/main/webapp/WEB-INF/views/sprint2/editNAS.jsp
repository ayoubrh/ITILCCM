...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification NAS - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					...
					<div class="panel-body">
						<f:form modelAttribute="nas" action="/config/admin/add/saveNAS" methode="post" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/nas?id=${nas.id }" />'">Annuler</button>
								</div>
