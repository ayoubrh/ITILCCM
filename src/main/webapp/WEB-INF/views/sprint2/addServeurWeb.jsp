...
<head>
	...
	<title>Nouveau Serveur Web - ITIL-CCM</title>
  ...
  <!-- Modal Contact -->
										...
										<tbody id="tableApplicationWebpopup">
											<c:forEach items="${applicationWeb}" var="aw">
												<tr class="gradeA" id="tr_ApplicationWeb_${aw.id }">
													<td class="supchekbox"><input type="checkbox" class="ckApp" name="chApplicationWeb" value="${aw.id }"></td>
													<td>${aw.nom }</td>
													<td>${aw.url }</td>
													<td>${aw.criticite}</td>
		...
		<div class="panel">
					...
					<div class="panel-body">
						<f:form modelAttribute="serveurWeb" action="saveServeurWeb" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
