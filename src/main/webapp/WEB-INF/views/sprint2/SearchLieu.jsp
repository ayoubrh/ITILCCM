...
-->
		...
		<div class="page-header">
			...
			<a href="<c:url value="/config/admin/add/lieu"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Cr�er nouveau Lieu</a>
		</div> <!-- / .page-header -->
		...
		<div class="panel search-panel">
			...
			<form action="lieu" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					...
					<input type="text" name="l" class="form-control" value="${lieu }" placeholder="Entrez le nom � rechercher...">
