...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Interface Physique - ITIL-CCM</title>
 ...
 <!-- Modal VLANs-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification Interface Physique</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="physique" action="/config/admin/add/savePhysique" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tableVlans">
											<c:forEach items="${physique.vlan}" var="v">
												<tr class="gradeA" id="tr_vlans_${v.id }">
													<td class="supchekbox"><input type="checkbox" class="ckvlan" checked="checked" name="ckVlans" value="${v.id }"></td>
													<td>${v.vlantag }</td>
													<td>${v.description }</td>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/physique?id=${physique.id }" />'">Annuler</button>
								</div>
