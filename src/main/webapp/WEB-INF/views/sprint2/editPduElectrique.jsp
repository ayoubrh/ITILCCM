...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification PDU - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification de PDU</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="pduElectrique" action="/config/admin/add/savePduElectrique" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
				...
				<div class="form-group ">
					<label for="jq-validation-email" class="col-sm-3 control-label">Date de fin de garantie</label>
						...
						<div class=" col-sm-9" >
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/pduElectrique?id=${pduElectrique.id }" />'">Annuler</button>
								</div>
