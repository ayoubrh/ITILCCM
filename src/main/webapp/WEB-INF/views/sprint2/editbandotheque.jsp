...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Bandothèque - ITIL-CCM</title>
...
-->
				...
				<!-- Modal Bande -->
				<div id="myModalbande" class="modal fade" tabindex="-1" role="dialog" style="display: none;">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Retour</button>
								<button type="button" class="btn btn-primary" data-dismiss="modal" id="addbande">Créer</button>
							</div>
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification d'un Bandothèque</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="bandotheque" action="/config/admin/add/saveBandotheque" methode="post" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
							...
							<div class="tab-content tab-content-bordered panel-padding">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tableEquipementreseaux">
												...
												<tr class="gradeA" id="tr_er_${er.id }">
													<td class="supchekbox"><input type="checkbox" class="cker" name="chequipementreseaux" value="${er.id }"></td>
													<td>${er.nom }</td>
													<td>${er.statut }</td>
													<td>${er.criticite }</td>
													<td>${er.lieu.nom }</td>
								...
								<div class="tab-pane fade widget-bandes" id="profile-tabs-bandes">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tablebandes">
											<c:forEach items="${bandotheque.bande}" var="bande">
												<tr class="gradeA" id="tr_bande_${er.id }">
									...
									<div class="form-group">
										<div class="col-sm-offset-3 col-sm-1">
											<button type="button" class="btn btn-warning btn-flat" id="suppbande">Retirer !</button>
										</div>
										
										<div class="col-sm-offset-1 col-sm-7">
											<button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModalbande">Ajouter de nouveau Bande</button>
										</div>
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tablecontrat">
												<c:forEach items="${bandotheque.contrat}" var="contrat">
												<tr class="gradeA" id="tr_contrat_${contrat.id }">
													<td class="supchekbox"><input type="checkbox" class="ckContrat" name="chContrat" value="${contrat.id }"></td>
													<td>${contrat.nom }</td>
													<td>${contrat.typeDeContrat }</td>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/bandotheque?id=${bandotheque.id }" />'">Annuler</button>
								</div>
