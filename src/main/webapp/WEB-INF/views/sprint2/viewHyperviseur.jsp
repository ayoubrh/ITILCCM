...
<head>
	...
	<title>Détail Hyperviseur - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						...
						<span class="panel-title col-md-9">Détail d'Hyperviseur</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/hyperviseur?id=${hyperviseur.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/hyperviseur?id=${hyperviseur.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
					    </s:authorize>
						<br>
					</div>
						...
						<div class="profile-content">
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Serveur : </label>
										<a href="<c:url value="/config/view/serveur?id=${hyperviseur.serveur.id }" />"> ${hyperviseur.serveur.nom }</a>
									</div>
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Date de mise en production: </label>
										<fmt:formatDate type="date" dateStyle="long" value="${hyperviseur.dateDeMiseEnProduction }" />
									</div>
								...
								<div class="tab-pane fade widget-tickets" id="profile-tabs-tickets">
										...
										<div class="table-primary">
											<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example-tickets">
												...
												<tbody>
												<c:forEach items="${hyperviseur.ticketsIncident}" var="ticket">
