...
-->
		...
		<div class="page-header">
			...
			<a href="<c:url value="/config/admin/add/pc"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Cr�er nouveau Ordinateur</a>
		</div> <!-- / .page-header -->
		...
		<div class="panel search-panel">
			...
			<form action="pc" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					...
					<input type="text" name="s" class="form-control" value="${s }" placeholder="Entrez le nom � rechercher...">
