...
<head>
	...
	<title>Recherche vCluster - ITIL-CCM</title>
...
-->
		...
		<div class="page-header">
			<h1 class="col-md-9"><i class="fa fa-search page-header-icon"></i>&nbsp;&nbsp;Rechercher des vClusters</h1>
			<s:authorize ifAnyGranted="ROLE_ADMIN">
		...
		<div class="panel search-panel">
			...
			<!-- Search form -->
			<form action="vcluster" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					<span class="input-group-addon no-background"><i class="fa fa-search"></i></span>
					<input type="text" name="v" class="form-control" value="${vcluster }" placeholder="Entrez le nom à chercher...">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table table-primary table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<c:forEach items="${cis}" var="ci">
										<tr class="gradeA">
											<td><a href="<c:url value="/config/view/vcluster?id=${ci.id }" />">${ci.nom }</a></td>
											<td>${ci.statut }</td>
											<td>${ci.criticite }</td>
