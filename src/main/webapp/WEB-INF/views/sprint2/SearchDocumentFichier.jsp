...
-->
		...
		<div class="page-header">
			...
			<a href="<c:url value="/config/admin/add/fichier"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Cr�er nouveau Document Fichier</a>
		</div> <!-- / .page-header -->
		...
		<div class="panel search-panel">
			...
			<form action="fichier" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					...
					<input type="text" name="df" class="form-control" value="${documentFichier }" placeholder="Entrez le nom � rechercher...">
