...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Equipement reseau - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification d'un Equipement reseau</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="equipementReseau" action="/config/admin/add/saveEquipementreseau" methode="post" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group required">
										...
										<div class="col-sm-9">
											<f:select  path="type" class="form-control" name="jq-validation-select2" id="jq-validation-select2">
												<f:option value="" label=""/>
												<f:option value="Routeur" label="Routeur"/>
												<f:option value="Switch" label="Switch"/>
											</f:select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<f:input path="versionIos" type="text" class="form-control" id="inputError-4" name="jq-validation-modele" />
											<f:errors path="versionIos" cssClass="help-block"></f:errors>
										</div>
									</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/equipementreseau?id=${equipementReseau.id }" />'">Annuler</button>
								</div>
