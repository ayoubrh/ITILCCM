...
-->
		...
		<div class="page-header">
			...
			<a href="<c:url value="/config/admin/add/note"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Cr�er nouveau Document Note</a>
		</div> <!-- / .page-header -->
		...
		<div class="panel search-panel">
			...
			<form action="note" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					...
					<input type="text" name="dn" class="form-control" value="${documentNote }" placeholder="Entrez le nom � rechercher...">
