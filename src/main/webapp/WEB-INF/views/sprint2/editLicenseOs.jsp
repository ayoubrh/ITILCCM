...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Licence OS - ITIL-CCM</title>
...
<!-- Modal Document -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification de Licence OS</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="licenseOs" action="/config/admin/add/saveLicenseOs" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tabledocument">
												<c:forEach items="${licenseOs.documents}" var="doc">
												<tr class="gradeA" id="tr_doc_${doc.id }">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tableServeurs">
												...
												<tr class="gradeA" id="tr_Serveurs_${s.id }">
													<td class="supchekbox"><input type="checkbox" checked="checked" class="ckserv" name="ckServeurs" value="${s.id }"></td>
