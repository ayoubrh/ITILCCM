...
<head>
	...
	<title>Recherche Licence Logiciel - ITIL-CCM</title>
...
-->
		...
		<div class="page-header">
			<h1 class="col-md-9"><i class="fa fa-search page-header-icon"></i>&nbsp;&nbsp;Recherche des Licences Logiciel</h1>
			<s:authorize ifAnyGranted="ROLE_ADMIN">
			<a href="<c:url value="/config/admin/add/licenceLogiciel"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Créer nouveau Licence Logiciel</a>
			</s:authorize>
		</div> <!-- / .page-header -->
		...
		<div class="panel search-panel">
			...
			<!-- Search form -->
			<form action="licenceLogiciel" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					<span class="input-group-addon no-background"><i class="fa fa-search"></i></span>
					<input type="text" name="ll" class="form-control" value="${licenceLogiciel }" placeholder="Entrez le nom à rechercher...">
