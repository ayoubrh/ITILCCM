...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Contact - ITIL-CCM</title>
...
-->
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification de Contact</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="contact" action="/config/admin/add/saveContact" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/contact?id=${contact.id }" />'">Annuler</button>
								</div>
