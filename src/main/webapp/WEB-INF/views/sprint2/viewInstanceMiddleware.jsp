...
<head>
	...
	<title>Détail Instance Middleware - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail d'Instance Middleware</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/instanceMiddleware?id=${instanceMiddleware.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/instanceMiddleware?id=${instanceMiddleware.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										...
										${instanceMiddleware.nom }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Middleware: </label>
										<a href="<c:url value="/config/view/middleware?id=${instanceMiddleware.middleware.id }" />">${instanceMiddleware.middleware.nom }</a>
									</div>
									
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Criticité : </label>
										${instanceMiddleware.criticite }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Date de mise en production: </label>
										<fmt:formatDate type="date" dateStyle="long" value="${instanceMiddleware.dateDeMiseEnProduction}" />
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label">Description: </label>
										${instanceMiddleware.description }
									</div>
								...
								<div class="tab-pane fade widget-tickets" id="profile-tabs-tickets">
										...
										<div class="table-primary">
											<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example-tickets">
												...
												<tbody>
												<c:forEach items="${instanceMiddleware.ticketsIncident}" var="ticket">
