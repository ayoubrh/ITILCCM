...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Processus Métier - ITIL-CCM</title>
 ...
 <!-- Modal Contact -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification de Processus Métier</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="processusMetier" action="/config/admin/add/saveProcessusMetier" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
				...
				<div class="form-group ">
					<label for="jq-validation-email" class="col-sm-3 control-label">Date de mise en production</label>
						...
						<div class=" col-sm-9" >
								...
								<div class="tab-pane fade widget-contacts" id="profile-tabs-contacts">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tableContact">
											<c:forEach items="${processusMetier.contacts}" var="contact">
												<tr class="gradeA" id="tr_contact_${contact.id }">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tabledocument">
												<c:forEach items="${processusMetier.documents}" var="doc">
													<tr class="gradeA" id="tr_doc_${doc.id }">
								...
								<div class="tab-pane fade widget-solutions" id="profile-tabs-solutions">
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<c:forEach items="${processusMetier.solutionApplicative}" var="sa">
													<tr class="gradeA" id="tr_SolutionApplicative_${sa.id }">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/processusMetier?id=${processusMetier.id }" />'">Annuler</button>
								</div>
