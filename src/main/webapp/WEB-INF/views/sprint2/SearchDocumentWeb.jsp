...
-->
		...
		<div class="page-header">
			...
			<a href="<c:url value="/config/admin/add/web"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Cr�er nouveau Document Web</a>
		</div> <!-- / .page-header -->
		...
		<div class="panel search-panel">
			...
			<form action="web" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					...
					<input type="text" name="dw" class="form-control" value="${documentWeb }" placeholder="Entrez le nom � rechercher...">
