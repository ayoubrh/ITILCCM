...
<!-- Modal Contact -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Nouveau Solution applicative</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="solutionApplicative" action="saveSolutionApplicative" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
