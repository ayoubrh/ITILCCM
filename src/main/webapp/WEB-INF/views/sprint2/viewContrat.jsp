...
<head>
	...
	<title>Détail Contrat - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail du Contrat</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/contrat?id=${contrat.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/contrat?id=${contrat.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
						...
						<div class="profile-content">
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Type de contrat : </label>
										${contrat.typeDeContrat }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Date de début : </label>
										<fmt:formatDate type="date" dateStyle="long" value="${contrat.dateDeDebut }" />
									</div>
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Date de fin : </label>
										<fmt:formatDate type="date" dateStyle="long" value="${contrat.dateDeFin }" />
									</div>
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Coût : </label>
										${contrat.cout }
									</div>
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Monnaie : </label>
										${contrat.monnaie }
									</div>
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Périodicité de facturation : </label>
										${contrat.periodiciteDeFacturation }
									</div>
									<div class="form-group">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tablecontact">
												<c:forEach items="${contrat.contacts}" var="contact">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tabledocument">
												<c:forEach items="${contrat.documents}" var="doc">
								...
								<div class="tab-pane fade widget-tickets" id="profile-tabs-tickets">
										...
										<div class="table-primary">
											<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example-tickets">
												...
												<tbody>
												<c:forEach items="${aw.ticketsIncident}" var="ticket">
