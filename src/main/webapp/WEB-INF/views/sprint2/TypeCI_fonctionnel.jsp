						...
						<div class="form-group">
								...
								<div class="col-sm-3">
									<select   class="form-control" name="type">
									     ...
									     <option value="/config/admin/add/bandotheque">Bandothèque</option>
									     <option value="/config/admin/add/chassis"  >Chassis</option>
										 <option value="/config/admin/add/dvr">DVR</option>
									     <option value="/config/admin/add/equipementreseau">Equipement réseau</option>
									     ...
									     <option value="/config/admin/add/nas"  >NAS</option>
									     ...
									     <option value="/config/admin/add/serveur"  >Serveur</option>
									     ...
									     <option value="/config/admin/add/switchsan"  >Switch SAN</option>
									     <option value="/config/admin/add/systemedestockage"  >Système de Stockage</option>
