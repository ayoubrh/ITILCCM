...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	...
	<title>Modification Chassis - ITIL-CCM</title>
...
-->
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tableMatrielpopup">
											<c:forEach items="${materiels}" var="mat">
												<tr class="gradeA" id="tr_mat_${mat.id }">
													<td class="supchekbox"><input type="checkbox" class="ckMat" name="chMateriel" value="${mat.id }"></td>
													<td>${mat.nom }</td>
													<td>${mat.statut }</td>
													<td>${mat.criticite }</td>
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification d'un Chassis</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="chassis" action="/config/admin/add/saveChassis" methode="post" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tableMatriel">
											<c:forEach items="${chassis.infrastructure}" var="mat">
												<tr class="gradeA" id="tr_mat_${mat.id }">
													<td class="supchekbox"><input type="checkbox" class="ckMat" checked="checked" name="chMateriel" value="${mat.id }"></td>
													<td>${mat.nom }</td>
													<td>${mat.statut }</td>
													<td>${mat.criticite }</td>
													<td>${mat.numeroDeSerie }</td>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/chassis?id=${chassis.id }" />'">Annuler</button>
								</div>
