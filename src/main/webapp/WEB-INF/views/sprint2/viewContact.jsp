...
<head>
	...
	<title>Détail Contact- ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail du Contact</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/contact?id=${contact.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/contact?id=${contact.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
						...
						<div class="profile-content">
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Prenom : </label>
										${contact.prenom }
									</div>
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Organisation : </label>
										${contact.organisme }
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Numéro d'employé : </label>
										${contact.numeroD_employe }
									</div>
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Email : </label>
										${contact.email }
									</div>
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Téléphone : </label>
										${contact.telephoneFixe }
									</div>
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Téléphone mobile : </label>
