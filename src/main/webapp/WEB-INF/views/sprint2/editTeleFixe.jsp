...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	...
	<title>Modification Téléphone Fixe - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification d'un Téléphone Fixe</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="telephoneFixe" action="/config/admin/add/saveTeleFixe" methode="post" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/telefixe?id=${telephoneFixe.id }" />'">Annuler</button>
								</div>
