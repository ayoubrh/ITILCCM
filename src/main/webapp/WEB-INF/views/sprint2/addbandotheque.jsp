...
<head>
	...
	<title>Nouveau Bandothèque - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Nouveau Bandothèque</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="bandotheque" action="saveBandotheque" methode="post" class="form-horizontal" id="jq-validation-form">
