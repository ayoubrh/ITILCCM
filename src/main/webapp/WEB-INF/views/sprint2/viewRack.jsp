...
<head>
	...
	<title>Détail Rack - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail du Rack</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/rack?id=${rack.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/rack?id=${rack.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										...
										<a href="<c:url value="/config/view/lieu?id=${rack.lieu.id }" />">${rack.lieu.nom }</a>
								...
								<div class="tab-pane fade widget-chassis" id="profile-tabs-chassis">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tablechassis">
											<c:forEach items="${rack.chassis}" var="chas">
												<tr class="gradeA" id="tr_chassis_${chas.id }">
													<td><a href="<c:url value="/config/view/chassis?id=${chas.id }" />">${chas.nom }</a></td>
													<td>${chas.statut }</td>
													<td>${chas.criticite }</td>
													<td>${chas.numeroDeSerie }</td>
													<td>${chas.numeroAsset }</td>
													<td><fmt:formatDate type="date" dateStyle="long" value="${chas.dateDeMiseEnProduction }" /></td>
												</tr>
											</c:forEach>
								...
								<div class="tab-pane fade widget-materiels" id="profile-tabs-materiels">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tableMatriel">
											...
											<c:forEach items="${rack.infrastructure}" var="mat">
												<tr class="gradeA" id="tr_mat_Mat_${mat.id }">
													...
													<td><fmt:formatDate type="date" dateStyle="long" value="${mat.dateDeMiseEnProduction }" /></td>
												</tr>
											</c:forEach>


											<c:forEach items="${rack.pduElectrique}" var="pdu">
												<tr class="gradeA" id="tr_mat_PDU_${pdu.id }">
													<td><a href="<c:url value="/config/view/pduelectrique?id=${pdu.id }" />">${pdu.nom }</a></td>
													<td>${pdu.statut }</td>
													<td>${pdu.criticite }</td>
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tablecontact">
												...
												<c:forEach items="${rack.contact}" var="contact">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tabledocument">
												<c:forEach items="${rack.document}" var="doc">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tablecontrat">
												...
												<c:forEach items="${rack.contrat}" var="contrat">
								...
								<div class="tab-pane fade widget-tickets" id="profile-tabs-tickets">
										...
										<div class="table-primary">
											<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example-tickets">
												...
												<tbody>
												<c:forEach items="${rack.ticketsIncident}" var="ticket">
