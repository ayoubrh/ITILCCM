...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Version OS - ITIL-CCM</title>
			...
			<ul class="navigation">
				...
				<li class="mm-dropdown">
					...
					<ul>
						...
						<li>
							<a tabindex="-1" href="<c:url value="/incid/view/ticket/fermees"/>"><span class="mm-text">Incidents ferm閑s</span></a>
						</li>
						</s:authorize>
					</ul>
				</li>
...
-->
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification de Version OS</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="versionOs" action="/config/admin/add/saveVersionOs" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
							...
							<div class="form-group required">
								...
								<div class="col-sm-9">
									<f:select  path="familleOs" class="form-control" name="jq-validation-select2" id="jq-validation-select2">
										 ...
										 <f:option value="Fedora"> Fedora</f:option>
										 <f:option value="CentOS"> CentOS</f:option>
										 <f:option value="RedHat"> RedHat</f:option>
										 <f:option value="Solaris"> Solaris</f:option>
										 <f:option value="SuSE"> SuSE</f:option>
										 <f:option value="MacOS X"> MacOS X</f:option>
										 <f:option value="HP-UX"> HP-UX</f:option>
									</f:select>
									<f:errors path="familleOs" cssClass="help-block"></f:errors>
							</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/versionOs?id=${versionOs.id }" />'">Annuler</button>
								</div>
