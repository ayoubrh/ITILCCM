...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Contrat - ITIL-CCM</title>
	...
	<!-- Modal contact -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification de Contrat</span>
					</div>
					
					<div class="panel-body">
						<f:form modelAttribute="contrat" action="/config/admin/add/saveContrat" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
					...
					<label for="jq-validation-email" class="col-sm-3 control-label">Date de début</label>
						...
						<div class=" col-sm-9" >
							<div class=" input-group date" id="bs-datepicker-component">
								<f:input path="dateDeDebut" type="text" class="form-control" name="start" />
					...
					<label for="jq-validation-email" class="col-sm-3 control-label">Date de fin</label>
				     		<div class=" col-sm-9" >
								<div class="input-group date" id="bs-datepicker-component2">
									<f:input path="dateDeFin" type="text" class="form-control" name="end" />
									<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
								</div>
				...
				<div class="form-group">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/contrat?id=${contrat.id }" />'">Annuler</button>
								</div>
