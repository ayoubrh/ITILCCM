...
<head>
	...
	<title>Recherche Version OS - ITIL-CCM</title>
			...
			<ul class="navigation">
				...
				<li class="mm-dropdown">
					...
					<ul>
						...
						<li>
							<a tabindex="-1" href="<c:url value="/incid/view/ticket/fermees"/>"><span class="mm-text">Incidents ferm�es</span></a>
						</li>
						</s:authorize>
					</ul>
				</li>
...
-->
		...
		<div class="page-header">
			<h1 class="col-md-9"><i class="fa fa-search page-header-icon"></i>&nbsp;&nbsp;Rechercher des Versions OS</h1>
			<s:authorize ifAnyGranted="ROLE_ADMIN">
			<a href="<c:url value="/config/admin/add/versionOs"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Cr�er nouveau Version OS</a>
			</s:authorize>
		</div> <!-- / .page-header -->
		...
		<div class="panel search-panel">
			...
			<!-- Search form -->
			<form action="versionOs" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					<span class="input-group-addon no-background"><i class="fa fa-search"></i></span>
					<input type="text" name="vo" class="form-control" value="${versionOs }" placeholder="Entrez le nom � rechercher...">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table table-primary table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<c:forEach items="${cis}" var="ci">
										<tr class="gradeA">
											<td><a href="<c:url value="/config/view/versionOs?id=${ci.id }" />">${ci.nom }</a></td>
											<td>${ci.familleOs }</td>
										</tr>
