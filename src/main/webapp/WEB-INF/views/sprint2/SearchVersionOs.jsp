...
-->
		...
		<div class="page-header">
			...
			<s:authorize ifAnyGranted="ROLE_ADMIN">
			<a href="<c:url value="/config/admin/add/versionOs"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Créer nouveau Version OS</a>
			</s:authorize>
		</div> <!-- / .page-header -->
		...
		<div class="panel search-panel">
			...
			<form action="versionOs" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					...
					<input type="text" name="vo" class="form-control" value="${versionOs }" placeholder="Entrez le nom à rechercher...">
