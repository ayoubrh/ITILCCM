...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	...
	<title>Détail Interface Logique - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail Interface Logique</span>
						<a href="<c:url value="/config/admin/edit/logique?id=${logique.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/logique?id=${logique.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
							...
							<div class="tab-content tab-content-bordered panel-padding">
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<a href="<c:url value="/config/view/machinevertuelle?id=${logique.machineVirtuelle.id }" />">${logique.machineVirtuelle.nom }</a>		
