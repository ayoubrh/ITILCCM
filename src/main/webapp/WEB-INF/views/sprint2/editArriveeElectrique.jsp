...
<head>
	...
	<title>Modification  Arrivée électrique - ITIL-CCM</title>
...
-->
				...
				<div id="myModalPDUs" class="modal fade" tabindex="-1" role="dialog" style="display: none;">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Retour</button>
								<button type="button" class="btn btn-primary" id="addpdu">Ajouter</button>
							</div>
						</div> <!-- / .modal-content -->
					</div> <!-- / .modal-dialog -->
				</div> <!-- /.modal -->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification d'Arrivée électrique</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="arriveeElectrique" action="/config/admin/add/saveArriveeElectrique" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<f:select  path="lieu.id" class="form-control" name="jq-validation-lieu" id="jq-validation-lieu">
										<f:option value=""></f:option>
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
										...
										<tbody id="tablePDUs">
											<c:forEach items="${arriveeElectrique.pduElectrique}" var="pdu">
												<tr class="gradeA" id="tr_pdu_${pdu.id }">
													<td class="supchekbox"><input type="checkbox" checked="checked" class="ckpdu" name="ckPDUs" value="${pdu.id }"></td>
													<td>${pdu.nom }</td>
													<td>${pdu.statut }</td>
													<td>${pdu.criticite }</td>
													<td>${pdu.marque }</td>
