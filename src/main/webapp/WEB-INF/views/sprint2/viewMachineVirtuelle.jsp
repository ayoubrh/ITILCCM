...
<head>
	...
	<title>Détail Machine virtuelle - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail du Machine virtuelle</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/machineVirtuelle?id=${machineVirtuelle.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/machineVirtuelle?id=${machineVirtuelle.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										...
										${machineVirtuelle.nom }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-select2" class="col-sm-3 control-label">Statut : </label>
										${machineVirtuelle.statut }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Criticité : </label>
										${machineVirtuelle.criticite }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">vCluster / Hyperviseur: </label>
										${machineVirtuelle.virtualisation.nom }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Licence OS: </label>
										<a href="<c:url value="/config/view/licenseOs?id=${machineVirtuelle.licenseOs.id }" />"> ${machineVirtuelle.licenseOs.nom }</a>
									</div>
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">IP : </label>
										${machineVirtuelle.ip }
									</div>
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">CPU : </label>
										${machineVirtuelle.cpu }
									</div>
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">RAM: </label>
										${machineVirtuelle.ram }
									</div>
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Date de mise en production: </label>
										<fmt:formatDate type="date" dateStyle="long" value="${machineVirtuelle.dateDeMiseEnProduction }" />
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label">Description: </label>
										${machineVirtuelle.description }
									</div>
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tableinterfacereseau">
												...
												<tr class="gradeA" id="tr_ir_${ir.id }">
													<td><a href="<c:url value="/config/view/logique?id=${vl.id }" />">${ir.nom }</a></td>
													<td>${ir.adresseIp }</td>
													<td>${ir.adresseMac }</td>
								...
								<div class="tab-pane fade widget-tickets" id="profile-tabs-tickets">
										...
										<div class="table-primary">
											<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example-tickets">
												...
												<tbody>
												<c:forEach items="${machineVirtuelle.ticketsIncident}" var="ticket">
