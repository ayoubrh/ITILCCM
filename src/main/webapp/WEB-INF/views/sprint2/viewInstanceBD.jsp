...
<head>
	...
	<title>Détail Instance de base de données - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						...
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/instanceBD?id=${instanceBD.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/instanceBD?id=${instanceBD.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										...
										<a href="<c:url value="/config/view/serveurBD?id=${instanceBD.serveurDeBasseDeDonnees.id }" />">${instanceBD.serveurDeBasseDeDonnees.nom }</a>
									</div>
									
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Criticité : </label>
										${instanceBD.criticite }
									</div>
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tablecontact">
												<c:forEach items="${instanceBD.contacts}" var="contact">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tabledocument">
												<c:forEach items="${instanceBD.documents}" var="doc">
								...
								<div class="tab-pane fade widget-solutions" id="profile-tabs-solutions">
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tableSolutionApplicative">
												<c:forEach items="${instanceBD.solutionApplicative}" var="sa">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tablecontrat">
												<c:forEach items="${instanceBD.contrats}" var="contrat">
								...
								<div class="tab-pane fade widget-tickets" id="profile-tabs-tickets">
										...
										<div class="table-primary">
											<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example-tickets">
												...
												<tbody>
												<c:forEach items="${instanceBD.ticketsIncident}" var="ticket">
