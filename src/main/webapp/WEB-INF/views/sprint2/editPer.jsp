...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	...
	<title>Modification Périphérique - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification d'un Périphérique</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="Peripherique" action="/config/admin/add/savePer" methode="post" class="form-horizontal" id="jq-validation-form">
					...
					<f:input path="id" type="hidden" readonly="true" class="form-control" id="inputError-4" name="jq-validation-matricule"  />
						...
						<div class="profile-content">
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<f:select  path="ordinateur.id" class="form-control" name="jq-validation-select2" id="jq-validation-select2">
												<f:option value="" label=""/>
												<c:forEach items="${pc }" var="ordi">
													<f:option value="${ordi.id }" label="${ordi.nom } - ${ordi.marque } - ${ordi.modele } - ${ordi.type }"/>
												</c:forEach>
											</f:select>
											<f:errors path="ordinateur.id" cssClass="help-block"></f:errors>
										</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/per?id=${Peripherique.id }" />'">Annuler</button>
								</div>
