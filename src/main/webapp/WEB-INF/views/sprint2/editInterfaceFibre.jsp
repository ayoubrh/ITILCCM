...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Modification Interface Fibre - ITIL-CCM</title>
...
-->
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Modification Interface Fibre</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="fibre" action="/config/admin/add/saveFibre" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
						...
						<div class="profile-content">
							...
							<div class="form-group required">
								...
								<div class="col-sm-9">
									...
									<div class="form-group required">
										<label for="jq-validation-email" class="col-sm-3 control-label">Mat閞iel</label>
										<div class="col-sm-9">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-1">
									<button type="reset" class="btn btn-lg btn-danger btn-flat" onclick="location.href='<c:url value="/config/view/fibre?id=${fibre.id}" />'">Annuler</button>
								</div>
