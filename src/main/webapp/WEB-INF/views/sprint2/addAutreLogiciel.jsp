...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<title>Nouveau Autre logiciel - ITIL-CCM</title>
...
-->
				...
				<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">Nouveau Autre logiciel</span>
					</div>
					<div class="panel-body">
						<f:form modelAttribute="autreLogiciel" action="saveAutreLogiciel" methode="post" enctype="multipart/form-data" class="form-horizontal" id="jq-validation-form">
