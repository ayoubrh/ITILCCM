...
<head>
	...
	<title>Détail Document Note - ITIL-CCM</title>
...
-->
				<c:if test="${save == true }">
					...
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail du Document Note</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/note?id=${documentNote.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/note?id=${documentNote.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
					<div class="panel-body">
						...
						<div class="profile-content">
							...
							<div class="form-group required">
								<label for="jq-validation-email" class="col-sm-3 control-label">Texte</label>
								${documentNote.texte}
