...
<head>
	...
	<title>Détail Licence Logiciel - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail de la Licence Logiciel</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						<a href="<c:url value="/config/admin/edit/licenceLogiciel?id=${licenceLogiciel.id }"/>" class="btn btn-success"><i class="fa"></i>&nbsp;Modifier</a>
						<a href="<c:url value="/config/admin/delete/licenceLogiciel?id=${licenceLogiciel.id }"/>" class="btn btn-danger"><i class="fa"></i>&nbsp;Supprimer</a>
						</s:authorize>
						<br>
					</div>
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										...
										${licenceLogiciel.logicielEtApplications.nom }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Limite d'utilisation: </label>
										${licenceLogiciel.limiteD_utilisation}
									</div>
									
									<div class="form-group required">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Perpetuelle: </label>
										${licenceLogiciel.perpetuelle }	
									</div>
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Date de début de validité : </label>
										<fmt:formatDate type="date" dateStyle="long" value="${licenceLogiciel.dateDeDebutDeValidite }" />
									</div>
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Date de mise en production: </label>
										<fmt:formatDate type="date" dateStyle="long" value="${licenceLogiciel.dateDeFinDeValiite }" />
									</div>
									<div class="form-group">
									...
									<div class="table-primary">
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered jq-datatables-example">
											...
											<tbody id="tabledocument">
												<c:forEach items="${licenceLogiciel.documents}" var="doc">
