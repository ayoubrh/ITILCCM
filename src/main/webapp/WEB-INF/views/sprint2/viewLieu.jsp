...
<head>
	...
	<title>Détail Lieu - ITIL-CCM</title>
...
-->
		...
		<div class="panel">
					<div class="panel-heading">
						<span class="panel-title col-md-9">Détail du Lieu</span>
						<s:authorize ifAnyGranted="ROLE_ADMIN">
						...
						<div class="profile-content">
							...
							<div class="tab-content tab-content-bordered panel-padding">
								<div class="widget-article-comments tab-pane panel no-padding no-border fade in active" id="profile-tabs-proprietes">
									...
									<div class="form-group">
										<label for="jq-validation-marque" class="col-sm-3 control-label">Adresse: </label>
										${lieu.adresse  }
									</div>
									
									<div class="form-group">
										<label for="jq-validation-modele" class="col-sm-3 control-label">Code postale: </label>
										${lieu.codePostale }
									</div>
									...
									<div class="form-group">
										<label for="jq-validation-cpu" class="col-sm-3 control-label">Pays : </label>
										${lieu.pays }
									</div>
