...
-->
		...
		<div class="panel search-panel">
			...
			<!-- Search form -->
			<form action="machineVirtuelle" class="search-form bg-primary">
				<div class="input-group input-group-lg">
					<span class="input-group-addon no-background"><i class="fa fa-search"></i></span>
					<input type="text" name="mv" class="form-control" value="${machineVirtuelle }" placeholder="Entrez le nom à chercher...">
