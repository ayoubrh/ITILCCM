					...
					<div class="panel-body">
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/contact" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Contact</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/lieu" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Lieu</span></a>
										...
										<div class="col-sm-4 col-md-4">
											<div class="stat-panel">
												...
												<div class="col-md-12">
													<a tabindex="-1" href="<c:url value="/config/admin/add/contrat" />"><span class="fa fa-angle-double-right"> Cr閑r un nouvel objet de type Contrat</span></a>
