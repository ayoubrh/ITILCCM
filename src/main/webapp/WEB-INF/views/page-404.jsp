...
<!-- Mirrored from infinite-woodland-5276.herokuapp.com/pages-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Mar 2016 01:48:29 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<title>Error 404 - ITIL-CCM</title>
...
<script>var init = [];</script>
	...
	<div class="error-text">
		...
		<span class="hr"></span>
		<br>
		QUELQUE CHOSE NE MARCHE PAS, OU QUE CETTE PAGE  EST INEXISTANTE ... PAS ENCORE
	</div> <!-- / .error-text -->
