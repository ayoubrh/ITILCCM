...
public class TestMetier {
	...
	public void test() {
		try{
			...
			m.ajouterUserRole(new User("AAAAAAA", "123456789", "RHNABRI", "Ayoub", "ayoub@gmail.com","Chef de Département"), d1, r1);
			System.out.println("ccccccccccccccccccccccccccccccccccc");
			m.ajouterUserRole(new User("BBBBBBB", "014725836", "RHNABRI", "Ayoub", "ayoub2@gmail.com","Ingénieur"), d1, r2);
